...
def run_prediction(request: PredictionRequest, logger: Callable[[str], None] | None = None) -> dict:
    ...
    _log(logger, "Extracting 8 selected radiomics features in img_env...")
    ...
    _log(logger, "Extracting 11 selected deep features in dl_env...")
    deep_result = run_deep_feature_worker(
        runtime_spec=request.deep_runtime,
